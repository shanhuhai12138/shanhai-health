...
-- 健康报告 - 二级菜单：报告详情
INSERT INTO `sys_menu` VALUES (2032, '报告详情', 203, 2, 'report/detail/:id', 'reservation/report/detail', NULL, 1, 0, 'C', '0', '0', 'reservation:report:query', 'eye', 'admin', NOW(), '', NULL, '报告详情菜单（隐藏）', TRUE);

-- ----------------------------
-- 为 admin 角色分配这些菜单权限（假设 admin 角色ID=1）
-- ----------------------------
